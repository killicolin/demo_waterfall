...
/* harmony import */ var read_json_lines_sync__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! read-json-lines-sync */ "./node_modules/read-json-lines-sync/build/index.js");
/* harmony import */ var read_json_lines_sync__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(read_json_lines_sync__WEBPACK_IMPORTED_MODULE_1__);
...
for (let i = 0; i < data.length; i++) {
  var trace = data[i].trace;
  for (let j = 0; j < trace.length; j++) {
    max=Math.max(max,trace[j]);
    min=Math.min(min,trace[j]);
  }
}

console.log("max "+max);
console.log("min "+min);
console.log("trace : " +data[0].trace.length);
...
let waterfall = spectral_graph__WEBPACK_IMPORTED_MODULE_0__["WaterfallGraph"].new(800,600,data[0].trace.length,600,min,max,turbo_colormap_data,component_id);
waterfall.run();
...
function readTextFile(file)
{
    ...
    rawFile.onreadystatechange = function ()
    {
        if(rawFile.readyState === 4)
        {
            ...
            {
                data = read_json_lines_sync__WEBPACK_IMPORTED_MODULE_1___default()(rawFile.responseText);
            }
        }
    }
    rawFile.send(null);
